...
@section('content')
    ...
    <div class="bg-white min-h-[600px] mx-h-[660] border border-gray-200 rounded-md shadow-xl overflow-y-auto scroll-thin">
        ...
        <div class="w-full bg-gray-800 rounded-t-md flex">
            ...
            <div class="w-full flex justify-end items-center"><a href="{{ route('employees.create') }}" class="text-white text-sm flex gap-1 mx-1 my-2 px-4 py-1 rounded-md border border-white shadow hover:bg-white hover:text-gray-900 transition ease-in-out duration-200">
